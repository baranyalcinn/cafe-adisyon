        ...
        <div className="group relative">
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              setVisibleLimit(40) // Arama değiştiğinde limiti sıfırla
            }}
...
export function OrderView({ onBack }: OrderViewProps): React.JSX.Element {
  ...
  // React 18: Arama yaparken klavyenin donmasını engeller. UI akıcı kalır.
  ...
  // Klavye Kısayolları (Güvenli Event Listener)
  useEffect(() => {
  ...
  // Ürünleri Filtreleme (Geciktirilmiş Arama Sorgusu Kullanılıyor)
  ...
  // Güvenli Sayfalama (Intersection Observer with Callback Ref)
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-background">
        ...
        <ScrollArea className="flex-1 h-full">
          <div className="p-4 pb-24">
            ...
            {/* Yeni ve Güvenli Loading Sentinel (Callback Ref) */}
            {filteredProducts.length > visibleLimit && (
              <div ref={lastElementRef} className="h-8 w-full flex items-center justify-center p-4">
